$(document).ready(function() {
    ...
    $(document).ready(function() {
        // Munculkan setiap card dengan delay bertahap
        ...
        // Munculkan setiap chart setelah card selesai dengan delay bertahap
        $('.chart').each(function(index) {
            $(this).delay(index * 200 + 1000).queue(function(next) {
                $(this).addClass('animate-slide-up');
                next();
            });
        });
    
        // Munculkan setiap elemen dalam budget-container setelah chart selesai
        $('.budget-container').each(function(index) {
            $(this).delay(index * 200 + 1200).queue(function(next) {
                $(this).addClass('animate-slide-up');
                next();
            });
        });
